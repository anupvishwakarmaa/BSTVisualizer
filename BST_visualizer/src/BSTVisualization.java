...
public class BSTVisualization extends JFrame {
    ...
    private JLabel labelInorder,labelPostOrder,lebelPreorder,labelHeight;
    private JLabel ansInorder,ansPreorder,ansHeight;
    private FrontMetrics frontMetrix;
